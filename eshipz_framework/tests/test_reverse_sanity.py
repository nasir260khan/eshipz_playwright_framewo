...
from utils.navigation import (
    go_to_reverse_create_page,
    go_to_reverse_list_page
)


@pytest.mark.sanity
def test_reverse_sanity_flow(logged_in_page):

    page = logged_in_page
    page.set_default_timeout(60000)

    print("\n===== REVERSE SANITY FLOW STARTED =====")
    ...
    try:
        print("\n===== CASE 1 : CREATE REVERSE SHIPMENT =====")
    ...
    try:
        ...
        print("✔ Schedule Pickup Successful")
    ...
    print("\n🎉 REVERSE SANITY SUITE COMPLETED")